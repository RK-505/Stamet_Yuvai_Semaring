...
# Deteksi apakah lat naik/turun
if var.lat.values[0] > var.lat.values[-1]:  # lat menurun
...
if var.size == 0 or var.isnull().all():
    st.error("⚠️ Data tidak tersedia untuk wilayah Krayan pada waktu dan parameter ini.")
    st.stop()
